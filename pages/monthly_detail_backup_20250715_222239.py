...
def render_product_performance_subtab(df_basic, summary_data):
    ...
    if not taaan_product_summary.empty:
        ...
        from utils.data_processor import format_number_value
...
def render_branch_product_cross_subtab(summary_data):
    ...
    if analysis_metric in ["TAAAN商談数", "承認数", "確定売上"]:
        try:
            from utils.data_processor import generate_branch_product_cross_data, format_number_value
...
def render_product_3month_comparison_subtab(json_data, selected_month):
    ...
    from utils.data_processor import load_product_3month_comparison_data, get_prev_months, format_number_value
...
def render_product_detail_subtab(df_basic):
    ...
    from utils.data_processor import aggregate_product_data_from_basic, format_number_value
